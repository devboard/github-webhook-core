 ...
 */
class PullRequestReviewCommentEventFactoryTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var PullRequestReviewCommentEventFactory
     */
    protected $object;
    ...
    {
        $this->object = new PullRequestReviewCommentEventFactory();
    }
