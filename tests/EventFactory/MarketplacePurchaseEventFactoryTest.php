 ...
 */
class MarketplacePurchaseEventFactoryTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var MarketplacePurchaseEventFactory
     */
    protected $object;
    ...
    {
        $this->object = new MarketplacePurchaseEventFactory();
    }
